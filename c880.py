...
with open("C:\\Users\\Rachit M Sood\\\Desktop\\Hw2\\Hw2\\Benchmark\\c880.v") as fp:
...
with open("C:\\Users\\Rachit M Sood\\\Desktop\\Hw2\\Hw2\\Benchmark\\c880.v") as fp:
   for num,line in enumerate(fp,1):
       ...
       if 'fanout9' in line:
         f9=f9+1
fall=(f2*2)+(f3*3)+(f4*4)+(f5*5)+(f6*6)+(f7*7)+(f8*8)+(f9*9)
#print(fall)
...
while '' in list1233:
   list1233.remove('')
list1233=list1233+input11
my_set1=set(list1233)
lengthh=len(my_set1)*2
...
with open ("C:\\Users\\Rachit M Sood\\\Desktop\\Hw2\\Hw2\\Benchmark\\c880_BF.txt","w")as fa:
   for line in w3:
       fa.write(line+"\n")
   fa.write("\n")
   fa.write("\n")
...
with open ("C:\\Users\\Rachit M Sood\\\Desktop\\Hw2\\Hw2\\Benchmark\\c880_AF.txt","w")as fa:
   for line in w3:
       fa.write(line+"\n")
   fa.write("\n")
   fa.write("-------------------------------------------")
